...
def init_app(self):
        ...
        self.graph_rt = RealTimeGraph(self)
        ...
        # Botón para iniciar medición en tiempo real
        self.iniciar_medicion_button = QPushButton("Iniciar medición en tiempo real")
        self.iniciar_medicion_button.setStyleSheet("background-color: #ffc107; color: black; font-weight: bold;")
        self.iniciar_medicion_button.clicked.connect(self.iniciar_medicion_tiempo_real)
        resultado_layout.addWidget(self.iniciar_medicion_button)
        ...
        graph_and_slider_layout.addWidget(self.graph_rt, stretch=3)
